...
/**
 * Implementazione di serializzable per definire <i>Driver</i> memoriazzato nel database grazie all'Entity. 
...
public class Driver implements Serializable {
    ...
    /**
     * Restituisce l'identificativo univoc del mezzo memorizzato nel database.
    ...
    /**
     * Modifica il valore dell'identificativo del cliente proprietario del mezzo.
     * @param client_id Long con il quale cambiare l'identificativo del proprietario.
     */
     ...
     * @param carYear Int con il quale cambiare l'anno di produzione della macchina.
     */
    ...
    /**
     * Restituisce il risultato intero di una funzione hash che codifica i parametri del autista
