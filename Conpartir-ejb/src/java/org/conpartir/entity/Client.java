...
/**
 * Implementazione di serializzable per definire <i>Client</i> memoriazzato nel
...
public class Client implements Serializable {
     ...
     *
     * @param gmailValue String con la quale cambiare il valore di Gmail del
     * Client
     */
